...
typedef uint8_t * (*internet_control_message_protocol_version4_context_echo_func_addrptr_t)(internet_control_message_protocol_version4_context_echo_t *, uint32_t);
typedef void (*internet_control_message_protocol_version4_context_echo_func_checksum_build_t)(internet_control_message_protocol_version4_context_echo_t *, const uint8_t *, uint64_t);
...
static internet_control_message_protocol_version4_context_echo_func_t func = {
    ...
    (internet_control_message_protocol_version4_context_echo_func_checksum_build_t) protocol_context_func_checksum_build
};
