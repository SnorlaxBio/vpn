...
struct internet_protocol_version6_module_func {
    ...
    int32_t (*out)(internet_protocol_version6_module_t *, protocol_path_node_t *, protocol_context_t *);
    internet_protocol_version6_context_t * (*context_gen)(internet_protocol_version6_module_t *, protocol_path_node_t *, protocol_context_t *);
    internet_protocol_version6_context_t * (*reply_gen)(internet_protocol_version6_module_t *, internet_protocol_version6_context_t *);
...
// extern int32_t internet_protocol_version6_module_func_out(internet_protocol_version6_module_t * module, protocol_path_node_t * node, protocol_context_t * child);
extern internet_protocol_version6_context_t * internet_protocol_version6_module_func_context_gen(internet_protocol_version6_module_t * module, protocol_path_node_t * node, protocol_context_t * child);
...
#define internet_protocol_version6_module_addrlen_get(module)                                       ((module)->addrlen)
#define internet_protocol_version6_module_number_get(module)                                        ((module)->type)
...
#define internet_protocol_version6_module_out(module, node, child)                                  ((module)->func->out(module, node, child))
#define internet_protocol_version6_module_context_gen(module, node, child)                          ((module)->func->context_gen(module, node, child))
#define internet_protocol_version6_module_reply_gen(module, request)                                ((module)->func->reply_gen(module, request))
...
struct internet_protocol_version6_module_host_func {
    ...
    int32_t (*out)(internet_protocol_version6_module_host_t *, protocol_path_node_t *, protocol_context_t *);
    internet_protocol_version6_context_t * (*context_gen)(internet_protocol_version6_module_host_t *, protocol_path_node_t *, protocol_context_t *);
    internet_protocol_version6_context_t * (*reply_gen)(internet_protocol_version6_module_host_t *, internet_protocol_version6_context_t *);
...
struct internet_protocol_version6_module_router_func {
    ...
    int32_t (*out)(internet_protocol_version6_module_router_t *, protocol_path_node_t *, protocol_context_t *);
    internet_protocol_version6_context_t * (*context_gen)(internet_protocol_version6_module_router_t *, protocol_path_node_t *, protocol_context_t *);
    internet_protocol_version6_context_t * (*reply_gen)(internet_protocol_version6_module_router_t *, internet_protocol_version6_context_t *);
...
struct internet_protocol_version6_context {
    ...
    sync_t * sync;
    ___reference internet_protocol_version6_module_t * module;
...
#define internet_protocol_version6_context_addrptr(context, type)                           ((context)->func->addrptr(context, type))
#define internet_protocol_version6_context_checksum_build(context, pseudo, pseudolen)       ((context)->func->checksum_build(context, pseudo, pseudolen))
...
#define internet_protocol_version6_context_packetlen_get(context)                           ((context)->packetlen)
#define internet_protocol_version6_context_packetlen_set(context, v)                        ((context)->packetlen = v)
...
#define internet_protocol_version6_context_payload_length_get(context)                      (htons((context)->packet->payload))
#define internet_protocol_version6_context_payload_length_set(context, v)                   ((context)->packet->payload = ntohs(v))
#define internet_protocol_version6_context_next_header_get(context)                         ((context)->packet->next)
#define internet_protocol_version6_context_next_header_set(context, v)                      ((context)->packet->next = v)
#define internet_protocol_version6_context_hop_limit_get(context)                           ((context)->packet->limit)
#define internet_protocol_version6_context_hop_limit_set(context, v)                        ((context)->packet->limit = v)
#define internet_protocol_version6_context_source_get(context)                              ((context)->packet->source)
#define internet_protocol_version6_context_source_set(context, v)                           (memcpy((context)->packet->source, v, 16))
#define internet_protocol_version6_context_destination_get(context)                         ((context)->packet->destination)
#define internet_protocol_version6_context_destination_set(context, v)                      (memcpy((context)->packet->destination, v, 16))
...
#define internet_protocol_version6_context_next_protocol_get(context)                       ((context)->packet->next)
#define internet_protocol_version6_context_next_packet_get(context)                         (&((protocol_packet_t *)((context)->packet))[internet_protocol_version6_packet_header_length_min])
#define internet_protocol_version6_context_next_packetlen_get(context)                      ((context)->packetlen - sizeof(internet_protocol_version6_packet_t))
...
struct internet_protocol_version6_extension_module_func {
    ...
    int32_t (*out)(internet_protocol_version6_extension_module_t *, protocol_path_node_t *, protocol_context_t *);
    internet_protocol_version6_extension_context_t * (*context_gen)(internet_protocol_version6_extension_module_t *, protocol_path_node_t *, protocol_context_t *);
    internet_protocol_version6_extension_context_t * (*reply_gen)(internet_protocol_version6_extension_module_t *, internet_protocol_version6_extension_context_t *);
};
...
#define internet_protocol_version6_extension_module_addrlen_get(module)                                         ((module)->addrlen)
#define internet_protocol_version6_extension_module_number_get(module)                                          ((module)->type)
...
#define internet_protocol_version6_extension_module_out(module, node, context)                                  ((module)->func->out(module, node, context))
#define internet_protocol_version6_extension_module_context_gen(module, node, child)                            ((module)->func->context_gen(module, node, child))
#define internet_protocol_version6_extension_module_reply_gen(module, request)                                  ((module)->func->reply_gen(module, request))
...
struct internet_protocol_version6_extension_context {
    ...
    sync_t * sync;
    ___reference internet_protocol_version6_extension_module_t * module;
    ___reference internet_protocol_version6_context_t * parent;
    protocol_context_array_t * children;
    int32_t error;
...
struct internet_protocol_version6_extension_context_func {
    ...
    uint8_t * (*addrptr)(internet_protocol_version6_extension_context_t *, uint32_t);
    void (*checksum_build)(internet_protocol_version6_extension_context_t *, const uint8_t *, uint64_t);
};
...
#define internet_protocol_version6_extension_context_addrptr(context, type)                         ((context)->func->addrptr(context, type))
#define internet_protocol_version6_extension_context_checksum_build(context, pseudo, pseudolen)     ((context)->func->checksum_build(context, pseudo, pseudolen))
...
struct internet_protocol_version6_extension_hopbyhop_module_func {
    ...
    int32_t (*out)(internet_protocol_version6_extension_hopbyhop_module_t *, protocol_path_node_t *, protocol_context_t *);
    internet_protocol_version6_extension_hopbyhop_context_t * (*context_gen)(internet_protocol_version6_extension_hopbyhop_module_t *, protocol_path_node_t *, protocol_context_t *);
    internet_protocol_version6_extension_hopbyhop_context_t * (*reply_gen)(internet_protocol_version6_extension_hopbyhop_module_t *, internet_protocol_version6_extension_hopbyhop_context_t *);
};
...
#define internet_protocol_version6_extension_hopbyhop_module_addrlen_get(module)                                        ((module)->addrlen)
#define internet_protocol_version6_extension_hopbyhop_module_number_get(module)                                         ((module)->type)
...
#define internet_protocol_version6_extension_hopbyhop_module_out(module, node, context)                                 ((module)->func->out(module, node, context))
#define internet_protocol_version6_extension_hopbyhop_module_context_gen(module, node, child)                           ((module)->func->context_gen(module, node, context))
#define internet_protocol_version6_extension_hopbyhop_module_reply_gen(module, request)                                 ((module)->func->reply_gen(module, request))
...
struct internet_protocol_version6_extension_hopbyhop_context {
    ...
    sync_t * sync;
    ___reference internet_protocol_version6_extension_hopbyhop_module_t * module;
    ___reference internet_protocol_version6_context_t * parent;
    protocol_context_array_t * children;
    int32_t error;
...
#define internet_protocol_version6_extension_hopbyhop_context_addrptr(context, type)                            ((context)->func->addrptr(context, type))
#define internet_protocol_version6_extension_hopbyhop_context_checksum_build(context, pseudo, pseudolen)        ((context)->func->checksum_build(context, pseudo, pseudolen))
...
#define internet_protocol_version6_extension_hopbyhop_context_length_set(context, v)                            ((context)->packetlen = v)
#define internet_protocol_version6_extension_hopbyhop_context_length_get(context)                               ((context)->packetlen)
...
struct internet_protocol_version6_extension_routing_module_func {
    ...
    int32_t (*out)(internet_protocol_version6_extension_routing_module_t *, protocol_path_node_t *, protocol_context_t *);
    internet_protocol_version6_extension_routing_context_t * (*context_gen)(internet_protocol_version6_extension_routing_module_t *, protocol_path_node_t *, protocol_context_t *);
    internet_protocol_version6_extension_routing_context_t * (*reply_gen)(internet_protocol_version6_extension_routing_module_t *, internet_protocol_version6_extension_routing_context_t *);
};
...
#define internet_protocol_version6_extension_routing_module_addrlen_get(module)                                         ((module)->addrlen)
#define internet_protocol_version6_extension_routing_module_number_get(module)                                          ((module)->type)
...
#define internet_protocol_version6_extension_routing_module_out(module, node, context)                                  ((module)->func->out(module, node, context))
#define internet_protocol_version6_extension_routing_module_context_gen(module, node, child)                            ((module)->func->context_gen(module, node, child))
#define internet_protocol_version6_extension_routing_module_reply_gen(module, request)                                  ((module)->func->reply_gen(module, request))
...
struct internet_protocol_version6_extension_routing_context {
    ...
    sync_t * sync;
    ___reference internet_protocol_version6_extension_routing_module_t * module;
    ___reference internet_protocol_version6_context_t * parent;
    protocol_context_array_t * children;
    int32_t error;
...
#define internet_protocol_version6_extension_routing_context_addrptr(context, type)                         ((context)->func->addrptr(context, type))
#define internet_protocol_version6_extension_routing_context_checksum_build(context, pseudo, pseudolen)     ((context)->func->checksum_build(context, pseudo, pseudolen))
...
#define internet_protocol_version6_extension_routing_context_length_set(context, v)                         ((context)->packetlen = v)
#define internet_protocol_version6_extension_routing_context_length_get(context)                            ((context)->packetlen)
...
struct internet_protocol_version6_extension_fragment_module_func {
    ...
    int32_t (*out)(internet_protocol_version6_extension_fragment_module_t *, protocol_path_node_t *, protocol_context_t *);
    internet_protocol_version6_extension_fragment_context_t * (*context_gen)(internet_protocol_version6_extension_fragment_module_t *, protocol_path_node_t *, protocol_context_t *);
    internet_protocol_version6_extension_fragment_context_t * (*reply_gen)(internet_protocol_version6_extension_fragment_module_t *, internet_protocol_version6_extension_fragment_context_t *);
};
...
#define internet_protocol_version6_extension_fragment_module_addrlen_get(module)                                        ((module)->addrlen)
#define internet_protocol_version6_extension_fragment_module_number_get(module)                                         ((module)->type)
...
#define internet_protocol_version6_extension_fragment_module_out(module, node, context)                                 ((module)->func->out(module, node, context))
#define internet_protocol_version6_extension_fragment_module_context_gen(module, node, context)                         ((module)->func->context_gen(module, node, context))
#define internet_protocol_version6_extension_fragment_module_reply_gen(module, request)                                 ((module)->func->reply_gen(module, request))
...
struct internet_protocol_version6_extension_fragment_context {
    ...
    sync_t * sync;
    ___reference internet_protocol_version6_extension_fragment_module_t * module;
    ___reference internet_protocol_version6_context_t * parent;
    protocol_context_array_t * children;
    int32_t error;
...
#define internet_protocol_version6_extension_fragment_context_addrptr(context, type)                            ((context)->func->addrptr(context, type))
#define internet_protocol_version6_extension_fragment_context_checksum_build(context, pseudo, pseudolen)        ((context)->func->checksum_build(context, pseudo, pseudolen))
...
#define internet_protocol_version6_extension_fragment_context_length_set(context, v)                            ((context)->packetlen = v)
#define internet_protocol_version6_extension_fragment_context_length_get(context)                               ((context)->packetlen)
...
struct internet_protocol_version6_extension_destination_module_func {
    ...
    int32_t (*out)(internet_protocol_version6_extension_destination_module_t *, protocol_path_node_t *, protocol_context_t *);
    internet_protocol_version6_extension_destination_context_t * (*context_gen)(internet_protocol_version6_extension_destination_module_t *, protocol_path_node_t *, protocol_context_t *);
    internet_protocol_version6_extension_destination_context_t * (*reply_gen)(internet_protocol_version6_extension_destination_module_t *, internet_protocol_version6_extension_destination_context_t *);
};
...
#define internet_protocol_version6_extension_destination_module_addrlen_get(module)                                         ((module)->addrlen)
#define internet_protocol_version6_extension_destination_module_number_get(module)                                          ((module)->type)
...
#define internet_protocol_version6_extension_destination_module_out(module, node, child)                                    ((module)->func->out(module, node, child))
#define internet_protocol_version6_extension_destination_module_context_gen(module, node, child)                            ((module)->func->context_gen(module, node, child))
#define internet_protocol_version6_extension_destination_module_reply_gen(module, request)                                  ((module)->func->reply_gen(module, request))
...
struct internet_protocol_version6_extension_destination_context {
    ...
    sync_t * sync;
    ___reference internet_protocol_version6_extension_destination_module_t * module;
    ___reference internet_protocol_version6_context_t * parent;
    protocol_context_array_t * children;
    int32_t error;
...
#define internet_protocol_version6_extension_destination_context_addrptr(context, type)                         ((context)->func->addrptr(context, type))
#define internet_protocol_version6_extension_destination_context_checksum_build(context, pseudo, pseudolen)     ((context)->func->checksum_build(context, pseudo, pseudolen))
...
#define internet_protocol_version6_extension_destination_context_length_set(context, v)                         ((context)->packetlen = v)
#define internet_protocol_version6_extension_destination_context_length_get(context)                            ((context)->packetlen)
