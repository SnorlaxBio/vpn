...
static int32_t internet_protocol_version6_extension_hopbyhop_module_func_deserialize(internet_protocol_version6_extension_hopbyhop_module_t * module, protocol_packet_t * packet, uint64_t packetlen, internet_protocol_version6_context_t * parent, internet_protocol_version6_extension_hopbyhop_context_t ** context);
static int32_t internet_protocol_version6_extension_hopbyhop_module_func_serialize(internet_protocol_version6_extension_hopbyhop_module_t * module, internet_protocol_version6_context_t * parent, internet_protocol_version6_extension_hopbyhop_context_t * context, protocol_packet_t ** packet, uint64_t * packetlen);
...
extern internet_protocol_version6_extension_hopbyhop_module_t * internet_protocol_version6_extension_hopbyhop_module_gen(internet_protocol_version6_extension_hopbyhop_context_handler_t on) {
    internet_protocol_version6_extension_hopbyhop_module_t * module = (internet_protocol_version6_extension_hopbyhop_module_t *) calloc(1, sizeof(internet_protocol_version6_extension_hopbyhop_module_t));
...
static int32_t internet_protocol_version6_extension_hopbyhop_module_func_deserialize(internet_protocol_version6_extension_hopbyhop_module_t * module, protocol_packet_t * packet, uint64_t packetlen, internet_protocol_version6_context_t * parent, internet_protocol_version6_extension_hopbyhop_context_t ** context) {
    ...
    if(*context == nil) *context = internet_protocol_version6_extension_hopbyhop_context_gen(module, parent, packet, packetlen, 0);

    if(packetlen < internet_protocol_version6_extension_length_min) {
        internet_protocol_version6_extension_hopbyhop_context_error_set(*context, EAGAIN);
        return fail;
    }

    internet_protocol_version6_extension_hopbyhop_t * segment = (internet_protocol_version6_extension_hopbyhop_t *) packet;

    internet_protocol_version6_extension_hopbyhop_context_length_set(*context, (1 + segment->length) * 8);

    if(packetlen < internet_protocol_version6_extension_hopbyhop_context_length_get(*context)) {
        internet_protocol_version6_extension_hopbyhop_context_error_set(*context, EAGAIN);
        return fail;
    }

    internet_protocol_version6_extension_hopbyhop_module_debug(module, stdout, *context);
...
static int32_t internet_protocol_version6_extension_hopbyhop_module_func_in(internet_protocol_version6_extension_hopbyhop_module_t * module, protocol_packet_t * packet, uint64_t packetlen, internet_protocol_version6_context_t * parent, internet_protocol_version6_extension_hopbyhop_context_t ** context) {
    ...
    if(internet_protocol_version6_extension_hopbyhop_module_deserialize(module, packet, packetlen, parent, context) == fail) {
        internet_protocol_version6_extension_hopbyhop_module_on(module, protocol_event_exception, parent, *context);
        return fail;
    }

    if(internet_protocol_version6_extension_hopbyhop_module_on(module, protocol_event_in, parent, *context) == fail) {
        internet_protocol_version6_extension_hopbyhop_module_on(module, protocol_event_exception, parent, *context);
        return fail;
    }

    internet_protocol_version6_extension_hopbyhop_module_on(module, protocol_event_in, parent, *context);
