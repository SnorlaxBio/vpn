...
static void internet_protocol_version6_extension_routing_module_func_on(internet_protocol_version6_extension_routing_module_t * module, uint32_t type, internet_protocol_version6_extension_routing_context_handler_t handler, internet_protocol_version6_context_t * parent, internet_protocol_version6_extension_routing_context_t * context);
static void internet_protocol_version6_extension_routing_module_func_notify(internet_protocol_version6_extension_routing_module_t * module, uint32_t type, internet_protocol_version6_context_t * parent, internet_protocol_version6_extension_routing_context_t * context, uint64_t ret);
...
static internet_protocol_version6_extension_routing_module_func_t func = {
    ...
    internet_protocol_version6_extension_routing_module_func_on,
    internet_protocol_version6_extension_routing_module_func_notify
};
