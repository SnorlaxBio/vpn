...
typedef uint8_t * (*internet_protocol_version6_extension_destination_context_func_addrptr_t)(internet_protocol_version6_extension_destination_context_t *, uint32_t);
typedef void (*internet_protocol_version6_extension_destination_context_func_checksum_build_t)(internet_protocol_version6_extension_destination_context_t *, const uint8_t *, uint64_t);
...
static internet_protocol_version6_extension_destination_context_func_t func = {
    ...
    (internet_protocol_version6_extension_destination_context_func_checksum_build_t) protocol_context_func_checksum_build
};
