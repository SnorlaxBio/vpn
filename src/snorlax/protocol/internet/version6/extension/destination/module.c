...
typedef int32_t (*internet_protocol_version6_extension_destination_module_func_out_t)(internet_protocol_version6_extension_destination_module_t *, internet_protocol_version6_extension_destination_context_t *, protocol_path_node_t *);
...
static internet_protocol_version6_extension_destination_module_func_t func = {
    ...
    (internet_protocol_version6_extension_destination_module_func_out_t) internet_protocol_version6_extension_module_func_out
};
...
static int32_t internet_protocol_version6_extension_destination_module_func_deserialize(internet_protocol_version6_extension_destination_module_t * module, protocol_packet_t * packet, uint64_t packetlen, internet_protocol_version6_context_t * parent, internet_protocol_version6_extension_destination_context_t ** context) {
    ...
    if(*context) *context = internet_protocol_version6_extension_destination_context_gen(module, parent, packet, packetlen);
