...
typedef int32_t (*internet_protocol_version6_module_host_func_deserialize_t)(internet_protocol_version6_module_host_t *, protocol_packet_t *, uint32_t, protocol_context_t *, internet_protocol_version6_context_t **);
typedef int32_t (*internet_protocol_version6_module_host_func_serialize_t)(internet_protocol_version6_module_host_t *, protocol_context_t *, internet_protocol_version6_context_t *, protocol_packet_t **, uint32_t *);
