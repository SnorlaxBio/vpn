...
typedef int32_t (*internet_protocol_version6_module_router_func_out_t)(internet_protocol_version6_module_router_t *, protocol_path_node_t *, protocol_context_t *);
...
static internet_protocol_version6_module_router_func_t func = {
    ...
    (internet_protocol_version6_module_router_func_out_t) protocol_module_func_out,
    nil,
    nil,
