...
extern int32_t internet_control_message_protocol_version6_message_length_validate(uint8_t type, uint64_t packetlen) {
    ...
    switch(type) {
        ...
        case internet_control_message_protocol_version6_message_type_router_solicitation:       return packetlen >= sizeof(internet_control_message_protocol_version6_router_solicitation_message_t);
