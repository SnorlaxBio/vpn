...
typedef void (*internet_control_message_protocol_version6_context_redirect_func_checksum_build_t)(internet_control_message_protocol_version6_context_redirect_t *, const uint8_t *, uint64_t);
...
static internet_control_message_protocol_version6_context_redirect_func_t func = {
    ...
    (internet_control_message_protocol_version6_context_redirect_func_checksum_build_t) protocol_context_func_checksum_build
};
