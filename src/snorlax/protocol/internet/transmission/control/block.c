...
static int32_t transmission_control_block_func_out(transmission_control_block_t * block, transmission_control_buffer_out_t * node);
...
___implement
extern transmission_control_protocol_context_t * transmission_control_block_func_context_gen_transmit_segment(transmission_control_block_t * block, transmission_control_buffer_out_t * data, uint8_t flags, uint8_t * buffer, uint64_t bufferlen) {
#ifndef   RELEASE
    snorlaxdbg(block == nil, false, "critical", "");
...
___implement extern int32_t transmission_control_block_func_check_window_remote(transmission_control_block_t * block, transmission_control_buffer_out_t * node) {
#ifndef   RELEASE
        snorlaxdbg(block == nil, false, "critical", "");
#endif // RELEASE
